...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    this.showKegiatan(); // console.log(this.meta);
  },
  methods: {
    getKegiatan: function () {
      var _getKegiatan = _asyncToGenerator(
      /*#__PURE__*/
      ...
      function getKegiatan() {
        return _getKegiatan.apply(this, arguments);
      }

      return getKegiatan;
    }(),
    getPanen: function () {
      var _getPanen = _asyncToGenerator(
      /*#__PURE__*/
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("apiproduksi/wherepanen?user=".concat(this.user.id, "&page=").concat(this.meta.current_page)).then(function (response) {
                  _this2.panens = response.data.data;
      ...
      function getPanen() {
        return _getPanen.apply(this, arguments);
      }
